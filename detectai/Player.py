...
class Pedestrian():
    ...
    def __del__(self):
        print
        "Pedestrian %d destroyed" % self.id
    ...
    def update(self, frame):
        ...
        # if args.get("algorithm") == "c" or 1 == 1:
...
def main():
    ...
    camera = cv2.VideoCapture(path.join(path.dirname(__file__), "C:/vsc/data/hockey-tracking/test2.avi"))
    ...
    out = cv2.VideoWriter('C:/vsc/data/hockey-tracking/output.avi', fourcc, 20.0, (640, 480))
    while True:
        print
        " -------------------- FRAME %d --------------------" % frames
